...
if __name__ == "__main__":
    ...
    if not os.path.exists(DATASET):
        import subprocess
        rc = subprocess.call("download_" + DATASET + ".sh")

    # preprocess_and_save(folder = os.path.join(DATASET, DATA_CLASS, 'points'),
    #                 save_path = './data/processedShapeNet/car_normalized/')